...
overlap = 0.2 #0.2, 0.5, 1.0 # do these produce different roughnesses?  

# for different particle packing
geoIter = 1 # must set seed bool = True if want different packing

geo_file = "cubeO_G"+str(geoIter)+"_L"+str(thickness) +"_T"+str(theta)+"_O"+str(overlap)
print geo_file
#exit()
